...
public:
    ...
    sorted_insert_iterator<Container, Compare>& operator*()
    {
        return *this;
    }
    ...
    sorted_insert_iterator<Container, Compare>& operator++(int)
    {
        return *this;
    }

    sorted_insert_iterator<Container, Compare>& operator=(typename Container::value_type const& value)
    {
